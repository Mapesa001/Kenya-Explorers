  ...
  return (
    <nav className="w-full bg-white shadow-md fixed top-0 left-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-3 md:py-4">
        ...
        <div
          className={`flex-col md:flex md:flex-row md:items-center md:space-x-6 md:static absolute left-0 top-full w-full md:w-auto bg-white px-4 md:px-0 transition-all duration-300 ease-in-out ${
            isOpen ? "flex" : "hidden"
          }`}
        >
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <button className="bg-primary cursor-pointer text-white px-4 py-1.5 rounded-md text-sm hover:bg-primary-dark">
      ...
      {isOpen && (
        <div className="md:hidden px-4 pb-4">
          ...
          <button className="bg-primary text-white px-4 py-2 rounded-md text-sm hover:bg-primary-dark">
            <Link to={"/signup"}>Sign Up</Link>
          </button>
        </div>
      )}
